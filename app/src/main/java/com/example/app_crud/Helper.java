...
public class Helper extends SQLiteOpenHelper {
    static final String dataBase = "base";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        //Tabla album
        sqLiteDatabase.execSQL("CREATE TABLE album (id_album integer NOT NULL CONSTRAINT album_pk PRIMARY KEY AUTOINCREMENT,nombre varchar(100) NOT NULL,f_lanzamiento date NOT NULL,precio float NOT NULL, src varchar(250) NOT NULL, artista_id_artista integer NOT NULL,CONSTRAINT album_artista FOREIGN KEY (artista_id_artista) REFERENCES artista (id_artista));");
        //Tabla album_genero
